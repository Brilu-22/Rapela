        ...
        <View style={styles.playerCard}>
            <View style={styles.artworkContainer}>
                ...
                <AnimatedImage 
                    ...
                    style={[styles.artwork, animatedArtworkStyle]}
                />
            </View>
            <View style={styles.trackInfo}>
                <Text style={styles.trackTitle} numberOfLines={1}>{currentTrack?.title || 'No Track Playing'}</Text>
...
const styles = StyleSheet.create({
    ...
    artworkContainer: { width: width * 0.6, height: width * 0.6, borderRadius: (width * 0.6) / 2, // Make it a circle
        shadowColor: '#000', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.2, shadowRadius: 8, elevation: 10, marginBottom: 25 },
    artwork: { width: '100%', height: '100%', borderRadius: (width * 0.6) / 2 }, // Make it a circle
